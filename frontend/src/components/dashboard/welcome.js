        ...
        <ul>
          ...
          <li>
            ...
            <p style={{ marginBottom: "2px" }}>
              <Button size="small" type="primary" shape="circle" icon="edit" />{" "}
      ...
      <div className="box-container">
        ...
        <ul>
          ...
          <li>
            Action - <br />{" "}
            <p style={{ marginBottom: "2px" }}>
              <Button size="small" type="primary" shape="circle" icon="info" />{" "}
        ...
        <ul>
          ...
          <ol>
            ...
            <ul>
              <li>
                Questions - Random {">"} Enter number of questions to be
                selected automatically and click Generate Test Paper. Click Next
                to proceed.
              </li>
              <li>
                Questions - Manually {">"} Select Questions manually . Click
                Next to proceed.
              </li>
            </ul>
          </ol>
          ...
          <p>
            <b>NOTE-</b>A link for this test has been sent to the email id of
